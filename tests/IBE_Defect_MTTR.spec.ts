...
test('IntelliBridge Enterprise Validation for Defect MTTR', async ({page}, testInfo) => {
  ...
  await testInfo.attach("screenshot",
    ...
    contentType: 'IntelliBridge Enterprise_Field_Issue/png' 
    }
    )
  console.log("-----------------------------------------------------------------------");
  console.log("IntelliBridge Enterprise Validation for Defect MTTR Field issue is completed successfully");
  console.log("-----------------------------------------------------------------------");
  ...
  await testInfo.attach("screenshot",
    { body:await page.screenshot(), 
    contentType: 'IntelliBridge Enterprise_Engineering_Issue/png' 
    }
    )
  console.log("-----------------------------------------------------------------------");
  console.log("IntelliBridge Enterprise Validation for Defect MTTR Engineering issue is completed successfully");
  console.log("-----------------------------------------------------------------------");
  await browser.close();
});