...
test('IntelliBridge Enterprise Validation for Avg feature cycle time', async ({page}, testInfo) => {
  ...
  await testInfo.attach("screenshot",
    ...
    contentType: 'IntelliBridge Enterprise_Avg_Feature_Cycle_Time/png' 
    }
    )
  console.log("-----------------------------------------------------------------------");
  console.log("IntelliBridge Enterprise Validation for Avg feature cycle time is completed successfully");
  console.log("-----------------------------------------------------------------------");
  await browser.close();
});